...
class _DetailsFicheIncidentState extends State<DetailsFicheIncident> {
  ...
  void initState() {
    ...
    bRensFichAcc = (widget.ficheIncidentDetails == null &&
  ...
  Widget _buildVictimesSection() {
    return Column(
      ...
      children: [
        _buildInfoTile(
          icon: Icons.people,
          title: "Victimes " + widget.ficheIncidentDetails!['blesse'] == 1
              ? "(Oui)"
              : "(Non)",
          content: Column(
            children: [
              _buildVictimeDetail(
                  "Nb blessé", widget.alertDetails['nb_blesse']),
            ],
          ),
        ),
      ],
            ...
            child: ListView(
              children: [
                ...
                if (widget.ficheIncidentDetails != null) ...[
                  if (widget.ficheIncidentDetails!['blesse'] == true)
                    _buildVictimesSection(),
                  if (widget.ficheIncidentDetails!['interruption_service'] !=
                      null) ...[
                    _buildInfoTile(
                      icon: Icons.electrical_services_rounded,
                      title: "Interruption service",
                      content: Text(
                        widget.ficheIncidentDetails!['interruption_service'] ==
                                1
                            ? "Oui"
                            : "Non",
                        style: const TextStyle(fontSize: 18),
