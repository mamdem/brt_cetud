...
class CollectIncidentVictimeScreen extends StatefulWidget {
  ...
  final int alertId;
  const CollectIncidentVictimeScreen(
      {Key? key, required this.incidentId, required this.alertId})
      : super(key: key);

  @override
  _CollectIncidentVictimeScreenState createState() =>
      _CollectIncidentVictimeScreenState();
}

class _CollectIncidentVictimeScreenState
    extends State<CollectIncidentVictimeScreen> {
  int currentStep = 1;
  final int nbStep = 2;
  int? _conscient;
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return BeautifulSuccessAlert(
          ...
          onPressed: () {
            Get.offAll(
                () => DetailsIncident(alertId: widget.alertId, initialTab: 1),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        buildRequiredLabel('Le victime est-il conscient ?'),
                        const SizedBox(height: 8),
                        Row(
                          children: [
                            Expanded(
