...
class FicheAccidentDegatMaterielsScreen extends StatefulWidget {
  final int accidentId;
  const FicheAccidentDegatMaterielsScreen({Key? key, required this.accidentId}) : super(key: key);

  @override
  _FicheAccidentDegatMaterielsScreenState createState() =>
      _FicheAccidentDegatMaterielsScreenState();
}

class _FicheAccidentDegatMaterielsScreenState extends State<FicheAccidentDegatMaterielsScreen> {
