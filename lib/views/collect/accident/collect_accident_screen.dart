...
class FicheAccidentScreen extends StatefulWidget {
  final int alertId;
  const FicheAccidentScreen({Key? key, required this.alertId}) : super(key: key);

  @override
  _FicheAccidentScreenState createState() => _FicheAccidentScreenState();
}

class _FicheAccidentScreenState extends State<FicheAccidentScreen> {
  int currentStep = 1;
  final int nbStep = 5;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Fiche Accident"),
        centerTitle: true,
