...
class SignalementAccidentScreen extends StatefulWidget {
  const SignalementAccidentScreen({Key? key}) : super(key: key);

  @override
  _SignalementAccidentScreenState createState() => _SignalementAccidentScreenState();
}

class _SignalementAccidentScreenState extends State<SignalementAccidentScreen> {
  ...
  bool _validateCurrentStep() {
    switch (currentStep) {
      ...
      case 3: // Validation du step "Victimes"
        if (_hasVictime && totalVictims == 0) {
          showError("Veuillez renseigner le nombre de victimes.");
          return false;
        }
        break;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Signalement Accident"),
        centerTitle: true,
